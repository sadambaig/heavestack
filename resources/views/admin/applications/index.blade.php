                           ...
                           <div class="table-responsive mb-4 mt-4">
                                  ...
                                  <table id="html5-extension" class="table table-hover dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="html5-extension_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            <td ><input type="checkbox" name="id" value="{{ $app->id }}"></td>
                                          <td>{{ ($app->job)? $app->job->title:'' }}</td>
                                            ...
                                            <td>
                                                <span class="badge badge-success">{{ $app->email_sent }}</span>
                                                </td>
                                            <td>
                                               @if($app->status=='Pending')
                                                <a href="{{ route('change.pending',['id'=>$app->id]) }}" class="badge badge-danger">{{ $app->status }}</a>
                                               @elseif($app->status=='Process')
                                                <a href="{{ route('change.process',['id'=>$app->id]) }}" class="badge badge-warning">{{ $app->status }}</a>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference6">
                                                      ...
                                                      <a class="dropdown-item delete-job" href="{{ route('application.delete',['id'=>$app->id]) }}">Delete </a>
