                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                        <div class="widget widget-card-one">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{asset('public/assets/img/profile-32.jpg')}}" alt="avatar">
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{asset('public/assets/img/g-8.png')}}" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="card-bottom-section">
                                    ...
                                    <div class="img-group">
                                        <img src="{{asset('public/assets/img/profile-19.jpg')}}" alt="avatar">
                                        <img src="{{asset('public/assets/img/profile-6.jpg')}}" alt="avatar">
                                        <img src="{{asset('public/assets/img/profile-8.jpg')}}" alt="avatar">
                                        <img src="{{asset('public/assets/img/profile-3.jpg')}}" alt="avatar">
                                    </div>
